...
class Drive_Dataset(Dataset):
    def __init__(self, data_root, img_dir="images", mask_dir="mask", mask_suffix='_mask.gif', image_suffix='.tif', transform=None) -> None:
        super().__init__()
        self.data_root = data_root
        self.img_dir = img_dir
        self.mask_dir = mask_dir
        self.transform = train_aug if transform is None else transform
        if "training" in data_root:
...
if __name__  == '__main__':
    dataset = Drive_Dataset("/data1/home/ict08/skinseg/skin_datasets/Drive/training")
