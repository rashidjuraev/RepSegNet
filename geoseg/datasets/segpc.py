...
class SegPCDataset(Dataset):
    def __init__(self, data_root, img_dir="x", mask_dir="semantic_y", mask_suffix='.bmp', image_suffix='.bmp', transform=None) -> None:
        super().__init__()
...
if __name__  == '__main__':
    dataset = SegPCDataset("/data1/hom1/ict04/dev/datasets/segpc/val")
