...
weights_name = f"RepUNeT_256_epoch_5e3{max_epoch}"
weights_path = "model_weights/drive/{}".format(weights_name)  # do not change
test_weights_name = "repunet_512_epoch_5e3"  # if save_top_k=3, there are v1,v2 model weights, i.e.xxx-v1, xxx-v2
log_name = 'drive/{}'.format(weights_name)  # do not change
...
#  define the network
net = Rep_UNET_down(num_classes=2)
...
dataset = CVC_Dataset("skin_datasets/Drive")
