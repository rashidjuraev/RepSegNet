...
weights_name = f"mixer_unet_512_epoch{max_epoch}"
weights_path = "model_weights/isic2018/{}".format(weights_name)  # do not change
test_weights_name = "mixer_unet_512_epoch"  # if save_top_k=3, there are v1,v2 model weights, i.e.xxx-v1, xxx-v2
...
train_dataset = ISIC_Dataset("/data1/hom1/ict04/dev/datasets/isic2018/train")
