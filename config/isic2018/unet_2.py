...
weights_name = f"unet_2_acc_epoch{max_epoch}"
weights_path = "model_weights/isic2018/{}".format(weights_name)  # do not change
test_weights_name = "unet_2_epoch"  # if save_top_k=3, there are v1,v2 model weights, i.e.xxx-v1, xxx-v2
...
#  define the network
net = UNet(n_classes=num_classes)
