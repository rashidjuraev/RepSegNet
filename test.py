...
def get_args():
    ...
    arg("-p", "--pretrained_path", type=Path, help="Path to the pretrained model.", required=False, default="")
...
class Supervision_Train(pl.LightningModule):
    ...
    def training_epoch_end(self, outputs):
        ...
        log_dict = {"train_loss": loss, 'train_mIoU': mIoU, 'train_F1': F1, 'train_OA': OA, 'train_jac': Jaccard, 'train_recall': Sensitivity, 'train_spec': Specificity}
...
def main():
    ...
    logger = WandbLogger(project="skinseg")
    ...
    trainer.validate(model, ckpt_path=args.pretrained_path)
